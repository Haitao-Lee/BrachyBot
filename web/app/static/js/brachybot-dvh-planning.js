...
const REPORT_STRINGS = {
    zh: {
        ...
        methodSteps: [
            ...
            '<b>种子规划</b>：贪心迭代放置策略，每个种子贡献 dose_unet_spacing1mm 剂量分布',
            '<b>剂量计算</b>：基于 dose_unet_spacing1mm CNN 模型',
    ...
    en: {
        ...
        methodSteps: [
            ...
            '<b>Seed planning</b>: greedy iterative placement with per-seed dose_unet_spacing1mm contributions',
            '<b>Dose calculation</b>: dose_unet_spacing1mm CNN model (checkpoint calibration recorded with the plan)',
