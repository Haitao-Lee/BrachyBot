...
class BrachyAgent:
    ...
    def _run_llm_function_calling(self, message: str, steps: List[Dict], step_id_ref: List[int]) -> str:
        ...
        system_prompt = (
            ...
            "    - 'github_repos': Search for GitHub repositories\n"
            "    - 'github_code': Search for code examples\n"
            "    - 'github_issues': Search for issues and discussions\n"
            "  - Clone repositories: Use clone_repo parameter with GitHub URL\n"
            "  - Search local repos: Use search_local_repo parameter with repo path\n"
