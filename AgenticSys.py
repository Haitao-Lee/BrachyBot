...
class BrachyAgent:
    ...
    def _run_llm_function_calling(self, message: str, steps: List[Dict], step_id_ref: List[int]) -> str:
        ...
        system_prompt = (
            ...
            "- 🌍 **Language Matching**: Always respond in the SAME language the user uses. If user writes in Chinese, your ENTIRE response must be in Chinese. If user writes in English, respond in English. NEVER mix languages in one response.\n"
            ...
            "  IMPORTANT: Present search results in the SAME language as the user's question.\n"
