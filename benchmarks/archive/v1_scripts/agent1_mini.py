...
def main():
    ...
    rf = "<workspace>/BrachyBot/docs/benchmark_result/reports/agent1_all_results.json"
    ...
    sd = f"<workspace>/BrachyBot/docs/benchmark_result/screenshots/{cat_num:02d}_{case_id}.png"
