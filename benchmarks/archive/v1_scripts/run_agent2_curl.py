...
LOG_FILE = '<workspace>/BrachyBot/docs/benchmark_result/agent2_curl.log'
...
def take_screenshot(case_id, cat_num):
    screenshot_path = '<workspace>/BrachyBot/docs/benchmark_result/screenshots/%02d_%s.png' % (cat_num, case_id)
