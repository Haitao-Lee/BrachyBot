...
RESULTS_FILE = "<workspace>/BrachyBot/docs/benchmark_result/reports/agent1_all_results.json"
...
if __name__ == "__main__":
    ...
    while i < len(remaining):
        ...
        for c in batch:
            ...
            screenshot_path = f"<workspace>/BrachyBot/docs/benchmark_result/screenshots/{cat_num:02d}_{case_id}.png"
