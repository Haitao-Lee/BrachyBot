...
SCREENSHOT_DIR = "<workspace>/BrachyBot/docs/benchmark_result/screenshots_v2"
REPORT_DIR = "<workspace>/BrachyBot/docs/benchmark_result/reports_v2"
BENCHMARK_DIR = "<workspace>/BrachyBot/benchmarks/v2"
LOG_FILE = "<workspace>/BrachyBot/docs/benchmark_result/auto_monitor_v2.log"
