#!/usr/bin/env python3
"""
Score-only runner for categories 28 and 29.
Screenshots already exist; this just queries the API and scores responses.
"""
...
def run_category(cat_num):
    ...
    for i, tc in enumerate(cases):
        ...
        result = {
            ...
            'response_time': resp_time, 'timestamp': datetime.now().isoformat()
        }
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(REPORT_DIR, "agent4_cats28_29_scores.json")
