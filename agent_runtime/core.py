        ...
        if lang == "zh":
            ...
            if is_planning:
                synth_prompt = (
                    ...
                    "Write 'Requires review against applicable site-specific guidance or the confirmed case protocol' "
                    "unless a retrieved source provides the exact site-specific constraint.\n\n"
                    "## 7. Review Items\n"
                    ...
                    "## 9. References\n"
                    "Inline links must point to retrieved clinical sources used for clinical claims. "
