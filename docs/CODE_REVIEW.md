...
`<workspace>/BrachyBot/.runtime/migration-backups/2e23320cb79342b89633e50b79f64be9-before-inline-20260830`
...
`<conda-env>/bin/python3.12 web/server.py --host
...
running `<conda-env>/bin/python3.12 web/server.py
--host 0.0.0.0` from `<workspace>/BrachyBot`, commit
...
- The live server was restarted from that checkout with PID `3181186`, cwd
  `<workspace>/BrachyBot`, and listener `0.0.0.0:8080`.
...
from `<workspace>/BrachyBot` after that commit; the new process
...
- The deployed server was restarted after the commit: old PID `2208988` was
  ...
  `<conda-env>/bin/python3.12 web/server.py
...
- New process: PID `2051260`, started `2026-08-26 03:37:12`, executable
  `<conda-env>/bin/python3.12`, command
...
- command: <conda-env>/bin/python3.12 web/server.py --host 0.0.0.0;
- listener: 0.0.0.0:8080;
...
- Repository: <workspace>/BrachyBot
...
<conda-env>/bin/python3.12 web/server.py --host 0.0.0.0
...
Running tests from the deployed `<workspace>/BrachyBot` tree
could still load the unrelated parent `<workspace>/config.py`
