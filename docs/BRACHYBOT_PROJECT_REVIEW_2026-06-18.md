...
ALLOWED_ROOTS = [
    ...
    Path("<workspace>/data").resolve(),  # 用户数据
...
print(_validate_path('<workspace>/BrachyBot/uploads/test.nii'))  # 应为 True
print(_validate_path('..'))  # 应为 False
print(_validate_path('<ssh-dir>/id_rsa'))  # 应为 False
"
...
4. `uploads/` 目录有 100+ 个 `CTpatient1_*.nii` 文件（自 2026-06-14 起），全部未加密，无清理 job
