...
- **Agent 1 Report:** `<workspace>/BrachyBot/docs/benchmark_result/reports/agent1_report.md`
- **Agent 2 Report:** `<workspace>/BrachyBot/docs/benchmark_result/reports/agent2_report.md`
- **Agent 3 Report:** `<workspace>/BrachyBot/docs/benchmark_result/reports/agent3_report.md`
- **Agent 4 Report:** `<workspace>/BrachyBot/docs/benchmark_result/reports/agent4_report.md`
- **Final Report:** `<workspace>/BrachyBot/docs/benchmark_result/reports/final_report.md`
