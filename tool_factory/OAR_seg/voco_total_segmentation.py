...
class VoCoTotalSegmentatorTool(BaseTool):
    ...
    DEFAULT_CONFIG = {
        "model_path": os.environ.get("VOCO_MODEL_PATH", "<workspace>/BrachyBot/VoCo/Totalsegmentator/model_voco_base_84.84.pt"),
        "model_large_path": os.environ.get("VOCO_MODEL_LARGE_PATH", "<workspace>/BrachyBot/VoCo/Totalsegmentator/model_voco_large_85.27.pt"),
        "out_channels": 104,
        "feature_size": 48,
