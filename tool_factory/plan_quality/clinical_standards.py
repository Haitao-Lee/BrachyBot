...
TARGET_STANDARDS: Dict[str, Dict[str, float]] = {
    "prostate":  {"d90_min_pct": 1.00, "v100_min": 0.90, "v150_max": 0.50, "v200_max": 0.20},
    "pancreas":  {"d90_min_pct": 1.00, "v100_min": 0.95, "v150_max": 0.50, "v200_max": 0.20},
    "liver":     {"d90_min_pct": 1.00, "v100_min": 0.90, "v150_max": 0.50, "v200_max": 0.20},
    "lung":      {"d90_min_pct": 1.00, "v100_min": 0.90, "v150_max": 0.50, "v200_max": 0.20},
    "kidney":    {"d90_min_pct": 1.00, "v100_min": 0.90, "v150_max": 0.50, "v200_max": 0.20},
    "colon":     {"d90_min_pct": 1.00, "v100_min": 0.90, "v150_max": 0.50, "v200_max": 0.20},
    "head_neck": {"d90_min_pct": 1.00, "v100_min": 0.90, "v150_max": 0.50, "v200_max": 0.20},
    "btcv":      {"d90_min_pct": 1.00, "v100_min": 0.90, "v150_max": 0.50, "v200_max": 0.20},
    "default":   {"d90_min_pct": 1.00, "v100_min": 0.90, "v150_max": 0.50, "v200_max": 0.20},
}
...
OAR_STANDARDS: Dict[str, Dict[str, Any]] = {
    "prostate": {
        "urethra":  {"max_dose": 150.0, "d10_pct_max": 150.0},
    ...
    "lung": {
        "spinal_cord":  {"max_dose": 30.0},
        "heart":        {"d2cc": 40.0, "max_dose": 60.0},
        "esophagus":    {"d2cc": 60.0, "max_dose": 75.0},
        "trachea":      {"d2cc": 75.0, "max_dose": 90.0},
    },
    "kidney": {
        "kidney":  {"d2cc": 18.0, "max_dose": 25.0},  # treated as both OAR and target
